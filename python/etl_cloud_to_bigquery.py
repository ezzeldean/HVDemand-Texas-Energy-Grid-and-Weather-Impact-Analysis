...
# get keys and setup BQ auth
eia_key = userdata.get('EIA_KEY')
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/content/hvdemand-14d09aa63552.json"
...
# 4. load to bigquery
table_id = 'hvdemand.demand_data.texas_grid_data'
df_merged.to_gbq(destination_table=table_id, project_id='hvdemand', if_exists='replace')
